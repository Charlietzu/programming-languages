...
\\037\000\012\000\039\000\011\000\043\000\010\000\044\000\009\000\
...
\\037\000\012\000\039\000\011\000\043\000\010\000\044\000\009\000\000\000\
\\001\000\003\000\023\000\005\000\022\000\008\000\021\000\010\000\020\000\
\\012\000\019\000\013\000\018\000\014\000\017\000\015\000\016\000\
...
\\039\000\011\000\041\000\046\000\043\000\010\000\044\000\009\000\000\000\
\\001\000\003\000\023\000\005\000\022\000\008\000\021\000\010\000\020\000\
\\012\000\019\000\013\000\018\000\014\000\017\000\015\000\016\000\
\\017\000\015\000\035\000\014\000\036\000\013\000\037\000\012\000\
\\039\000\011\000\043\000\010\000\044\000\009\000\000\000\
...
\\038\000\081\000\041\000\027\000\000\000\
\\001\000\011\000\038\000\016\000\037\000\017\000\036\000\018\000\035\000\
\\019\000\034\000\020\000\033\000\021\000\032\000\022\000\031\000\
\\023\000\030\000\024\000\029\000\026\000\028\000\040\000\142\000\
\\041\000\027\000\046\000\142\000\000\000\
\\001\000\011\000\038\000\016\000\037\000\017\000\036\000\018\000\035\000\
\\019\000\034\000\020\000\033\000\021\000\032\000\022\000\031\000\
\\023\000\030\000\024\000\029\000\026\000\127\000\041\000\027\000\000\000\
\\001\000\011\000\038\000\016\000\037\000\017\000\036\000\018\000\035\000\
\\019\000\034\000\020\000\033\000\021\000\032\000\022\000\031\000\
\\023\000\030\000\024\000\029\000\026\000\128\000\041\000\027\000\000\000\
\\001\000\011\000\038\000\016\000\037\000\017\000\036\000\018\000\035\000\
\\019\000\034\000\020\000\033\000\021\000\032\000\022\000\031\000\
\\023\000\030\000\024\000\029\000\026\000\139\000\041\000\027\000\000\000\
...
\\001\000\027\000\106\000\028\000\079\000\038\000\105\000\041\000\078\000\000\000\
\\001\000\028\000\079\000\041\000\078\000\000\000\
\\001\000\028\000\079\000\042\000\102\000\000\000\
...
\\038\000\093\000\041\000\046\000\000\000\
\\001\000\032\000\051\000\033\000\050\000\034\000\049\000\037\000\084\000\
\\041\000\046\000\000\000\
...
\\019\000\034\000\020\000\033\000\021\000\032\000\022\000\031\000\
\\023\000\030\000\024\000\029\000\026\000\028\000\041\000\027\000\000\000\
\\143\000\000\000\
\\144\000\000\000\
\\145\000\000\000\
\\146\000\000\000\
...
\\019\000\034\000\020\000\033\000\021\000\032\000\022\000\031\000\
\\023\000\030\000\024\000\029\000\041\000\027\000\000\000\
\\150\000\000\000\
\\151\000\041\000\027\000\000\000\
...
\\024\000\029\000\041\000\027\000\000\000\
\\153\000\041\000\027\000\000\000\
\\154\000\041\000\027\000\000\000\
\\155\000\041\000\027\000\000\000\
\\156\000\041\000\027\000\000\000\
\\157\000\018\000\035\000\019\000\034\000\041\000\027\000\000\000\
\\158\000\018\000\035\000\019\000\034\000\041\000\027\000\000\000\
\\159\000\041\000\027\000\000\000\
\\160\000\041\000\027\000\000\000\
\\161\000\018\000\035\000\019\000\034\000\041\000\027\000\000\000\
\\162\000\016\000\037\000\017\000\036\000\018\000\035\000\019\000\034\000\
\\022\000\031\000\023\000\030\000\024\000\029\000\041\000\027\000\000\000\
...
fn (T 0) => "VARIAVEL"
  ...
  | (T 38) => "CHAVEESQUERDA"
  | (T 39) => "CHAVEDIREITA"
  | (T 40) => "COLCHETEESQUERDO"
  | (T 41) => "COLCHETEDIREITO"
  | (T 42) => "NOME"
  | (T 43) => "CINT"
  | (T 44) => "FUNCAONORMAL"
  | (T 45) => "EOF"
...
ParserData.MlyValue.VOID,p1,p2))
fun SOMA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 15,(
ParserData.MlyValue.VOID,p1,p2))
fun SUBTRACAO (p1,p2) = Token.TOKEN (ParserData.LrTable.T 16,(
ParserData.MlyValue.VOID,p1,p2))
fun MULTIPLICACAO (p1,p2) = Token.TOKEN (ParserData.LrTable.T 17,(
ParserData.MlyValue.VOID,p1,p2))
fun DIVISAO (p1,p2) = Token.TOKEN (ParserData.LrTable.T 18,(
ParserData.MlyValue.VOID,p1,p2))
fun IGUAL (p1,p2) = Token.TOKEN (ParserData.LrTable.T 19,(
ParserData.MlyValue.VOID,p1,p2))
fun DIFERENTE (p1,p2) = Token.TOKEN (ParserData.LrTable.T 20,(
ParserData.MlyValue.VOID,p1,p2))
fun MENOR (p1,p2) = Token.TOKEN (ParserData.LrTable.T 21,(
ParserData.MlyValue.VOID,p1,p2))
fun MENOROUIGUAL (p1,p2) = Token.TOKEN (ParserData.LrTable.T 22,(
ParserData.MlyValue.VOID,p1,p2))
fun ADICIONAELEMENTOLISTA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 
23,(ParserData.MlyValue.VOID,p1,p2))
fun DOISPONTOS (p1,p2) = Token.TOKEN (ParserData.LrTable.T 24,(
ParserData.MlyValue.VOID,p1,p2))
fun PONTOEVIRGULA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 25,(
ParserData.MlyValue.VOID,p1,p2))
fun VIRGULA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 26,(
ParserData.MlyValue.VOID,p1,p2))
fun SETA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 27,(
ParserData.MlyValue.VOID,p1,p2))
fun BARRA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 28,(
ParserData.MlyValue.VOID,p1,p2))
fun UNDERSCORE (p1,p2) = Token.TOKEN (ParserData.LrTable.T 29,(
ParserData.MlyValue.VOID,p1,p2))
fun SETADUPLA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 30,(
ParserData.MlyValue.VOID,p1,p2))
fun LISTA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 31,(
ParserData.MlyValue.VOID,p1,p2))
fun BOOLEANO (p1,p2) = Token.TOKEN (ParserData.LrTable.T 32,(
ParserData.MlyValue.VOID,p1,p2))
fun INTEIRO (p1,p2) = Token.TOKEN (ParserData.LrTable.T 33,(
ParserData.MlyValue.VOID,p1,p2))
...
ParserData.MlyValue.VOID,p1,p2))
fun CHAVEESQUERDA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 38,(
ParserData.MlyValue.VOID,p1,p2))
fun CHAVEDIREITA (p1,p2) = Token.TOKEN (ParserData.LrTable.T 39,(
ParserData.MlyValue.VOID,p1,p2))
fun COLCHETEESQUERDO (p1,p2) = Token.TOKEN (ParserData.LrTable.T 40,(
ParserData.MlyValue.VOID,p1,p2))
fun COLCHETEDIREITO (p1,p2) = Token.TOKEN (ParserData.LrTable.T 41,(
ParserData.MlyValue.VOID,p1,p2))
